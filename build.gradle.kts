...
loom {
    ...
    forge {
        ...
        mixinConfig("mixins.flipped.json")
    }
    mixin {
        defaultRefmapName.set("mixins.flipped.refmap.json")
    }
}
        ...
        manifest {
            attributes(
                mapOf(
                    ...
                    "TweakOrder" to "0",
                    "MixinConfigs" to "mixins.flipped.json",
                )
            )
        }
        dependsOn(shadowJar)
